...
function Prod16() {
    return (
        <MDBContainer className="mt-5 mb-3">
            <h1>MICROBIAL ID &AST ANALYSIS SYSTEM</h1>
            <MDBRow className="justify-content-center align-items-center">
                ...
                <MDBCol lg={7}>
                    <p className="">
                        Applicable to clinical microbial identification and susceptibility Test.
                    </p>
                    ...
                    <p> <b>Features <br /></b>
                        ...
                        <br />
                        More accurate MIC value.

                        <br />
                        More stable quality diagnosis.
