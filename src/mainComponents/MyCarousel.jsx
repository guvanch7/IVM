        ...
        <Link to={'/catalog1'}>
          ...
          <div className='mask' style={{ backgroundColor: 'rgba(0, 0, 0, 0.1)' }}>
            <div className='col-5 carousel-block2'>
              <h1 className='display-3 fw-bolder carousel-txt'>Cytology With AI </h1>
        ...
        <Link to={'/catalog2'}>
          ...
          <div className='mask' style={{ backgroundColor: 'rgba(0, 0, 0, 0.1)' }}>
            <div className='col-5 carousel-block3'>
              <h1 className='display-5 fw-bolder  carousel-txt'>Histopothology & Laborotory Supplies With AI </h1>
